      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <div className="flex items-center gap-3 bg-gray-900 rounded-lg p-4">
            <code className="flex-1 text-green-400 font-mono text-lg">{stratumUrl}</code>
          ...
          <div className="bg-gray-900 rounded-lg divide-y divide-gray-800">
            ...
            <div className="p-4">
              <div className="flex items-center gap-4">
                <span className="text-gray-500 text-sm w-20">Username</span>
                <code className="text-yellow-400 font-mono">YOUR_TETSUO_ADDRESS</code>
              </div>
              <p className="text-gray-500 text-xs mt-2 ml-24">
            ...
            <div className="p-4">
              <div className="flex items-center gap-4">
                <span className="text-gray-500 text-sm w-20">Password</span>
                <code className="text-yellow-400 font-mono">x</code>
        ...
        <div>
          ...
          <div className="bg-gray-900 rounded-lg p-4">
            <div className="bg-gray-950 rounded p-3 font-mono text-sm space-y-1">
              <div><span className="text-gray-500">Pool URL:</span> <span className="text-green-400">{stratumUrl}</span></div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm">
              ...
              <p className="text-gray-400 mt-1">
                Add worker name after address: <code className="text-yellow-400 bg-gray-800 px-1 rounded">TYourAddress.rig1</code>, <code className="text-yellow-400 bg-gray-800 px-1 rounded">TYourAddress.rig2</code>
              </p>
              <p className="text-gray-500 mt-1 text-xs">
                Payouts go to your address. Worker name is just for tracking stats per rig.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-blue-900/20 border border-blue-800 rounded-lg p-4 flex items-start gap-3">
          ...
          <div className="text-sm">
            ...
            <p className="text-blue-300/80 mt-1">
              Just use your TETSUO wallet address as username.
              Payouts are sent automatically when balance reaches {minPayout} TETSUO.
            </p>
          </div>
        </div>
      </div>
